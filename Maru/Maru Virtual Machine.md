...
| switch         | switch value (value, blockid offset)...     | value: a register to switch on<br>(value, blockid, offset)...: branches to switch on if the values match                                                          |                                                                                                                                                                                                                         |
| match          | match object (variant_id, blockid, offset)  | object: the sum type to match on<br>(value, blockid, offset)...: branches to match on if the sum type matches variant                                             |                                                                                                                                                                                                                         |
